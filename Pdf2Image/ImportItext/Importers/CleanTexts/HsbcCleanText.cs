...
namespace Pdf2Image.ImportItext.Importers.CleanTexts
{
    public static class HsbcCleanText
    {
        public static List<string> CleanAllText(List<string> lines)
        {
        ...
        private static List<string> CleanSeparatorLines(List<string> lines)
        {
            var result = new List<string>();
        ...
        private static List<string> CleanUnnecesaryData(List<string> lines)
        {
            var result = new List<string>();
        ...
        private static List<string> CleanHeaderData(List<string> lines)
        {
            var result = new List<string>();
